...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
  ...
  <?php 
    ...
    <form class="d-flex" action ="uhome1.php" method ="POST">
      ...
      <a href ="ucustomerprofile.php"><img src="<?php echo $image ?>" alt="image" style="width:50px;height:50; border-radius: 50%;"></a>
    </div>
  </div>
</nav>
</header>
...
while($result =mysqli_fetch_array($query)){
  ...
  <div class="row">
    <div class="col-sm-9">
    <h6 class="card-title"><?php echo $result['hotel'];?>.</h6>
