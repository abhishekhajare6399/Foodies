...
<div class="content">
  <h3>FOODIES</h3>
  <p>Login In Your self With Foodies and Order your Favorite Food from any Hotel.</p>
...
<div class="row">
  ...
  <div class="form-group">
    <div class="form-check">
      ...
      <label class="form-check-label" for="gridCheck">
      Forgot Password <a href="uforgotpass1.php">Click </a> here.
      </label><br>
      <label class="form-check-label" for="gridCheck">
...
if(isset($_POST['submit']))
{
    ...
    $email_search =" select * from signup where email ='$email' and status='Active' and mstatus='Active' ";
