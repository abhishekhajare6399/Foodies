...
while($result =mysqli_fetch_array($query)){
    ...
    <div class="card" style="width: 15.5rem;height:17rem;padding:8px;">
    <img src="<?php echo $result['image'];?>" class="card-img-top" alt="..." style="width:100%;height:150;display:flex;">    
    <div class="row">
    <div class="col-sm-7">
