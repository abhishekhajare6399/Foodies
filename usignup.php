...
<div class="content">
  <h3>FOODIES</h3>
  <p>Register Your self With Foodies and Order your Favorite Food from any Hotel.</p>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputAddress2" name="waddress" placeholder="Apartment, studio, or floor">
  </div>
  <div class="row">
    <div class="col-sm-6">
...
if($emalcount>0)
{
  ...
  {
$insertquery ="insert into signup(loginid,name,mobile,email,password,cpassword,address,waddress,city,state,pincode,date,time,image,status,mstatus,token,otp) 
values('$rand','$username','$mobile','$email','$pass','$cpass','$address','$waddress','$city','$state','$zip','$date','$time','image/profile.jpg','Inactive','Inactive','$token','$otp')";
...
if($iquery)
{
  ?>
    ...
    <?php
  $subject = "FOODIES Account Activation";
...
<br><br>
          ...
          http://localhost/Food/uactivation.php?token=$token</h2>
...
$selectquery = "select * from signup where loginid ='$rand' ";
